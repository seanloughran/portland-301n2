...
articleView.initNewArticlePage = function() {
  // done TODO: Ensure the main .tab-content area is revealed. We might add more tabs later.
  $('.tab-content').show();

  // done TODO: Any new article we create will be copy/pasted into our source data file.
...
articleView.create = function() {
  ...
  // what does this mean? interface to the handlebars template
  $('#article-preview').append(article.toHtml());

  // done TODO: Activate the highlighting of any code blocks (ex:
  $('.article-body pre code').each(function(i,block){
    hljs.highlightBlock(block);
  });


  // done TODO: Export the new article as JSON, so it's ready to copy/paste into blogArticles.js:
  $('#article-export').show();
