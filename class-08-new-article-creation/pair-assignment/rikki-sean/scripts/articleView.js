...
articleView.create = function() {
  ...
  article = new Article({
    title: $('#artile-title').val(),
    body: $('#article-body').val(),
    aurthor: $('#article-author').val(),
    authorUrl: $('#article-aurthor-url').val(),
...
```
  ...
  */
  ...
  $('#articele-export').show();
  console.log('final json=\n%s', JSON.stringify(article, null, '    '));
