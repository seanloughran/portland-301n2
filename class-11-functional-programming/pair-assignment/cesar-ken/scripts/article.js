(function(window) {
  // CRJ: Wrap the entire contents of this file in an IIFE.
  ...
  // CRJ: Refactor this function, and provide it with a parameter of a callback function
  ...
  Article.numWordsByAuthor = function() {
    ...
    return Article.allAuthors().map(function(author, idx) {
      ...
      return {
        ...
        numWords:  function() {
          return Article.all
            ...
            .reduce(function (accumulator, iterator) {
