// DONE RH AND JS: Wrap the entire contents of this file in an IIFE.
...
// DONE-RH AND JS: Refactor this function, and provide it with a parameter of a callback function
...
// DONE RH AND JS: Chain together a `map` and a `reduce` call to get a rough count of all words in all articles.
...
// DONE-RH AND JS : Chain together a `map` and a `reduce` call to produce an array of unique author names.
...
Article.numWordsByAuthor = function() {
  // DONE-RH AND JS: Transform each author string into an object with 2 properties: One for
